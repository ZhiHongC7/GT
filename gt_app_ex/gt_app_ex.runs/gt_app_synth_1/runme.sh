...
HD_PWD='c:/Users/Administrator/Desktop/GT/gt_app_ex/gt_app_ex.runs/gt_app_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gt_app.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gt_app.tcl
