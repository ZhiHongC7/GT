...
HD_PWD='c:/Users/Administrator/Desktop/GT/gt_app_ex/gt_app_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gt_app_exdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gt_app_exdes.tcl
